...
class _ReviewQuestionsState extends State<ReviewQuestions> {
  ...
  solutionWidget() {
    for (int index = 0; index < widget.listQuestionsReview![widget.questionIndex].answers!.length; index++) {
      if(widget.listQuestionsReview![widget.questionIndex].answers![index].value == 1 &&  widget.listQuestionsReview![widget.questionIndex].answers![index].solution!.isNotEmpty){
        return  Column(
          children: [
            Container(
              color: reviewDividerColor,
