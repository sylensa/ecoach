...
class SpeedTestQuestionView extends StatefulWidget {
  SpeedTestQuestionView(
      {Key? key,
  ...
  @override
  State<SpeedTestQuestionView> createState() => _SpeedTestQuestionViewState();
}

class _SpeedTestQuestionViewState extends State<SpeedTestQuestionView> {
  _fieldFocusChange(
                                        ...
                                        return GestureDetector(
                                          onTap: () async{
                                            setState(() {
                                              ...
                                              if (controller.questions[i].selectedAnswer!.id != controller.questions[i].correctAnswer!.id) {
                                                completeQuiz();
                                              } else {
                                                nextButton();
                                              }
  ...
  // getTimerWidget2(String duration){
