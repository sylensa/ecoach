  ...
  void startTimer() {
    setState(() {
      ...
      if (controller.countdown == 0) {
        controller.countdown = 3840;
      }
      _start = controller.countdown;
    });
    // _start = countdown;
    ...
    _timer = Timer.periodic(
      ...
      (Timer timer) async {
        if (_start == 0) {
          ...
          setState(() {
            values = (_start - 1) / controller.countdown;
            value = 1.0 - values;
            _start--;
          });
        }
        ...
        body: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    "${controller.avgTime.toStringAsFixed(2)}s",
                    style: const TextStyle(
                      fontSize: 10,
                      color: Color(0xFF9EE4FF),
                    ),
            ...
            LinearProgressIndicator(
              // backgroundColor: Color(0xFFE0F0FC),
              value: value,
              minHeight: 12,
              valueColor:
