...
class _KeywordQuestionViewState extends State<KeywordQuestionView> {
  _fieldFocusChange(
  ...
  double get score {
    int totalQuestions = widget.numberOfQuestionSelected;
  ...
  String get responses {
    ...
    for (int t = 0; t < widget.numberOfQuestionSelected; t++) {
      ...
      Map<String, dynamic> answer = {
        ...
        "topic_id": controller.questions[t].topicId,
        "topic_name": controller.questions[t].topicName,
        "selected_answer_id": controller.questions[t].selectedAnswer != null
            ? controller.questions[t].selectedAnswer!.id
            : null,
  ...
  saveTest(
    ...
    print("testing connection ${testTaken.toJson()}");
