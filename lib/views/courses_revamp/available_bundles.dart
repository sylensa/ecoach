...
class AvailableBundles extends StatefulWidget {
  ...
  @override
  State<AvailableBundles> createState() => _HomePageAnnexState();
}

class _HomePageAnnexState extends State<AvailableBundles> {
        ...
        title:  Row(
          ...
          children: [
            Text(
              ...
              style: TextStyle(color: kSecondaryTextColor, fontSize: 20,fontWeight: FontWeight.w600),
            ),
            Container(
        ...
        child: Column(
          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                child: widget.user.promoCode != null ?
                Container(
