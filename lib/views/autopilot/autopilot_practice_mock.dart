...
import 'package:ecoach/views/autopilot/autopilot_quiz_view.dart';
...
class AutopilotPractiseMock extends StatefulWidget {
  AutopilotPractiseMock({this.count = 0, required this.controller});
  AutopilotController controller;

  int count;

  @override
  State<AutopilotPractiseMock> createState() => _AutopilotPractiseMockState();
}

class _AutopilotPractiseMockState extends State<AutopilotPractiseMock> {
