                ...
                child: DataTable(
                  ...
                  rows: [
                    makeDataRow(
                      ...
                      onSelectChanged: handleTableSelectChanged(0),
                    ),
                    makeDataRow(
                      cell1Text: 'Density',
                      cell2Text: '5.2s',
                      ...
                      onSelectChanged: handleTableSelectChanged(1),
                    ),
                    makeDataRow(
                      cell1Text: 'Pressure',
                      cell2Text: '5.2s',
                      ...
                      onSelectChanged: handleTableSelectChanged(2),
                    ),
                    makeDataRow(
                      cell1Text: 'Machines',
                      cell2Text: '5.2s',
                      ...
                      onSelectChanged: handleTableSelectChanged(3),
                    ),
                    makeDataRow(
                      cell1Text: 'Water',
                      cell2Text: '5.2s',
                      ...
                      onSelectChanged: handleTableSelectChanged(4),
                    ),
                  ],
                ),
              ),
