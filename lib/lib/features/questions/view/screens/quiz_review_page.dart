            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    "${(widget.testTaken!.correct!/widget.testTaken!.totalQuestions) * 100}%",
                    style: TextStyle(
                      fontSize: 10,
                      color: Color(0xFF9EE4FF),
                    ),
                  ...
                  InkWell(
                    ...
                    child: SvgPicture.asset(
                      savedQuestions.contains(reviewQuestionsBack[questionIndex].id) ? "assets/images/off_switch.svg" : "assets/images/on_switch.svg",
                    ),
                  ),
                ],
              ),
            ...
            children: [
              Expanded(
                child:  AdeoHtmlTex(
                  ...
                  useLocalImage: false,
                  textColor: ((reviewQuestionsBack[questionIndex].selectedAnswer!.id == answer.id && answer.value == 1) ||  answer.value == 1) ||  (reviewQuestionsBack[questionIndex].isCorrect && reviewQuestionsBack[questionIndex].selectedAnswer!.id == answer.id) || (reviewQuestionsBack[questionIndex].isWrong && reviewQuestionsBack[questionIndex].selectedAnswer!.id == answer.id)  ? Colors.white : Colors.black,
                  fontSize: 14,
