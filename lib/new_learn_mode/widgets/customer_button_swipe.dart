...
class CustomSwipeableButtonView extends StatefulWidget {
  ...
  const CustomSwipeableButtonView(
      {Key? key,
  ...
  @override
  _CustomSwipeableButtonViewState createState() =>
      _CustomSwipeableButtonViewState();
}

class _CustomSwipeableButtonViewState extends State<CustomSwipeableButtonView>
                  ...
                  child: Container(
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[widget.buttonWidget],
                      ),
                    ),
                    height: 60.0,
                  ),
