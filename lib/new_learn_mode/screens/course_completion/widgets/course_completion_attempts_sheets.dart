...
class CourseCompletionStudyAttemptsSheets extends StatefulWidget {
  final CourseCompletionStudyProgress progress;
  final String title;
  const CourseCompletionStudyAttemptsSheets(
      {Key? key, required this.progress, required this.title})
      : super(key: key);

  @override
  State<CourseCompletionStudyAttemptsSheets> createState() =>
      _CourseCompletionStudyAttemptsSheetsState();
}

class _CourseCompletionStudyAttemptsSheetsState
    extends State<CourseCompletionStudyAttemptsSheets> {
  ...
  void initState() {
    ...
    setState(() {
      CourseCompletionStudyController()
          .getAllCourseCompletionAttemptsByProgress(widget.progress)
          .then((value) {
        setState(() {
          attempts = value;
        });
